...
class PostService extends BaseService
{
    ...
    public function findPosts(array $condition = [], int $languageId = 1, array $orderBy = ['posts.id', 'DESC'], int $limit = 10){
        return $this->postRepository->findPosts($condition, $languageId, $orderBy, $limit);
    }

    public function findPostsPagination(array $condition = [], int $languageId = 1, array $orderBy = ['posts.id', 'DESC'], int $perPage = 6, int $page = 1){
        return $this->postRepository->findPostsPagination($condition, $languageId, $orderBy, $perPage, $page);
    }
}
