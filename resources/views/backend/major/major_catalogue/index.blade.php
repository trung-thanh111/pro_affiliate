    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <x-backend.filter createRoute="major_catalogue.create" submitRoute="major_catalogue.index" />
                <x-backend.customtable :records="$majorCatalogues->getCollection()" :columns="[
                    'name' => [
                        'label' => 'Tiêu đề',
                        '',
                        'render' => fn($item) => e(
