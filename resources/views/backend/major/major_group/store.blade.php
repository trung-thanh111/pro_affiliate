...
@php
    $url = ($config['method'] == 'create') ? route('major_group.store') : route('major_group.update', $majorGroup->id);
@endphp
<form action="{{ $url }}" method="post" class="box">
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        <div class="row">
            <div class="col-lg-9">
                @php
                    $translation = (isset($majorGroup)) ? $majorGroup->languages->first()->pivot : null;
                @endphp
                <x-backend.content
            ...
            <div class="col-lg-3">
                <x-ibox heading="Chọn Danh mục cha">
                     <x-backend.select2
                        ...
                        name="major_group_catalogue_id"
                        :selectedValue="$major_group->major_group_catalogue_id ?? 0"
                    />
                </x-ibox>
                ...
                <x-ibox heading="Cấu hình nâng cao">
                    <x-backend.select2 
                        ...
                        name="publish"
                        :selectedValue="$major_group->publish ?? 0"
                        class="mb10"
                    />
                </x-ibox>
            </div>
