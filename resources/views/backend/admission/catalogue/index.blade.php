    ...
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <x-backend.filter createRoute="admission.catalogue.create" submitRoute="admission.catalogue.index" />
                <x-backend.customtable :records="$admissions->getCollection()" :columns="[
                    'name' => [
                        'label' => 'Loại Tuyển Sinh',
                        '',
