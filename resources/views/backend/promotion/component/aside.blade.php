            ...
            <div class="form-row">
                <div class="uk-flex uk-flex-middle">
                    <input 
                        ...
                        value="1"
                        id="isPrimary"
                        {{ (old('is_primary', ($model->is_primary ?? 0)) == 1) ? 'checked' : '' }}
                    >
                    <label class="fix-label ml5" for="isPrimary">Đặt làm khuyến mãi chính (Trang chủ)</label>
                </div>
                <div class="text-small text-muted mt5">Lưu ý: Chỉ nên có 1 chương trình khuyến mãi chính tại một thời điểm.</div>
            </div>
        </div>
    </div>
...
<input 
    type="hidden" 
    class="input-buy-product-take-gift" 
    value="{{ json_encode(__('module.buy_product_take_gift')) }}"
>
<input 
    type="hidden" 
