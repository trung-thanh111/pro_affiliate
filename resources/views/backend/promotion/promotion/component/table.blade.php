            ...
            <tr >
                ...
                <td>
                    <div>
                        ...
                        @if($promotion->is_primary == 1)
                            <span class="label label-primary ml5">Chính</span>
                        @endif
                    </div> 
                ...
                <td class="text-center js-switch-{{ $promotion->id }}"> 
                    <input type="checkbox" value="{{ $promotion->publish }}" class="js-switch status" data-namespace="Product" data-field="publish" data-model="{{ $config['model'] }}" {{ ($promotion->publish == 2) ? 'checked' : '' }} data-modelId="{{ $promotion->id }}" />
                </td>
